...
const menuArray = [
  ...
  },
  {
    ...
    subMenu: [
      ...
      { subTitle: "93㎡", subUrl: "/FloorPlan/84B" },
      ...
      <>
        ...
        <div className={styles.mobileHeader}>
          <div onClick={() => setIsMobileMenu(!isMobileMenu)}>
            {!isMobileMenu ? (
              <AiOutlineMenu className={styles.icon} size={25} color="#011342" />
            ) : (
              <IoCloseSharp className={styles.icon} size={25} color="#011342" />
            )}
          </div>
          {isMobileMenu && (
            <SlideMenu
          ...
          <a href="tel:1533-8848">
            <IoCall className={styles.icon} size={25} color="#011342" />
          </a>
        </div>
