    ...
    <div className={styles.container}>
      ...
      <MenuBar contents={menuContents} />
        ...
        <h1 className={styles.screenReaderOnly}>
          더샵 신문 그리니티 2차 - 84B 평면안내
        </h1>
        <p className={styles.screenReaderOnly}>
          더샵 신문 그리니티 2차 84B 타입 평면 안내입니다. 4Bay 중심의 효율적 동선과
          채광·통풍을 고려한 설계, 팬트리·드레스룸 등 수납 특화 요소를 확인하세요.
          라이프스타일에 맞춘 옵션/확장 구성을 비교해 나에게 맞는 공간을 선택할 수 있습니다.
        </p>

        <div className={styles.textBox}>
          <div>일상을 넓히는 84B</div>
          <div>더샵 신문 그리니티 2차, 중대형의 여유를 담다</div>
        </div>
