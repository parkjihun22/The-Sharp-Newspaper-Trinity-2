...
const Interior2 = () => {
  const menuContents = [
    { title: "46㎡", url: "/Interior/59A" },
    { title: "59A㎡", url: "/Interior/A" },
  ];
  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.screenReaderOnly}>
        더샵 신문 그리니티 2차 인테리어 안내입니다. 전용 84·93㎡ 중심의 공간 구성에 맞춘 컬러 패키지,
        프리미엄 마감재와 수납 특화(팬트리·드레스룸·현관창고) 사양을 소개합니다. 주방·거실·침실·욕실 등
        공간별 포인트와 선택 옵션을 확인해 취향에 맞는 스타일을 선택하세요.
      </p>
