  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>더샵 신문 그리니티 2차 - 단지배치도</title>
        <meta
          name="description"
          content="더샵 신문 그리니티 2차 단지배치도: 동 배치, 조경, 커뮤니티, 주차·보행 동선까지 한눈에. 남향 위주·4Bay 판상형과 넓은 동간거리로 쾌적한 단지 환경을 제공합니다."
        />
        <meta
          name="keywords"
        ...
        <meta name="twitter:title" content="더샵 신문 그리니티 2차 - 단지배치도" />
        <meta
      ...
      <p className={styles.screenReaderOnly}>
        단지 배치도 페이지에서는 더샵 신문 그리니티 2차의 동 배치, 조경, 커뮤니티,
        주차·보행 동선을 시각적으로 안내합니다. 남향 위주·4Bay 판상형과 넓은 동간거리,
        공원형 조경으로 쾌적한 생활환경을 제공합니다.
      </p>

      <div className={styles.textBox}>
        <div>쾌적함을 설계한 배치</div>
        <div>더샵 신문 그리니티 2차, 공원형 단지의 일상을 누리다</div>
      </div>
