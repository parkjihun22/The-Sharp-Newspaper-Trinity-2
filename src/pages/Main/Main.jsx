...
const section3Contents = [
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `도심·광역 교통 프리미엄`,
    text2: `장유IC·서김해IC 인접<br />
            (예정) 장유역(부전~마산선)·BRT 연계`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `설계·조경의 차이`,
    text2: `남향 위주 4Bay 판상형·넓은 동간거리<br />
            공원형 조경·수납 특화 설계`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `브랜드 & 커뮤니티`,
    text2: `더샵 브랜드의 상품 경쟁력<br />
            피트니스·스크린골프·스터디룸·게스트하우스`,
        ...
        <>
          ...
          {!isOpenPopup2 && isOpenPopup3 && (
            ...
            <div className={styles.imageContainer}>
              <img src={mainImage} className={styles.mainImage} alt="더샵 신문 그리니티 2차-mainimage1" />
              <div className={styles.overlay}></div>
              <div className={styles.mainImageTextBox}>
                <div className={styles.mainImageTextSub}>
                  장유·율하 생활권 <span className={styles.greyText}>원스톱 인프라</span> | 장유IC·서김해IC <span className={styles.greyText}>광역 교통</span> | (예정) 장유역·BRT 연계 <span className={styles.greyText}>편리한 이동</span>
                </div>
                <div className={styles.mainImageTitleBox}>
                  <div className={styles.mainImageText}>신문1지구의 새로운 중심</div>
                  <div className={styles.mainImageLine}></div>
                  <div className={styles.mainImageText}>더샵 신문 그리니티 2차</div>
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                "사전 방문 예약 고객 전원 스타벅스 기프티콘 100% 증정"
              </div>
              <div className={styles.text3}>
                - 더샵 신문 그리니티 2차, 더샵 브랜드의 시그니처 라이프<br />
                - 장유·율하 생활권, 김해관광유통단지(아울렛·워터파크·하나로클럽) 인접<br />
                - 장유IC·서김해IC, (예정) 장유역(부전~마산선)·BRT 연계로 광역 접근성 강화<br />
                - 남향 위주 4Bay 판상형·공원형 조경·특화 커뮤니티로 완성도 높은 주거
              </div>
              ...
              <div className={styles.menuBox}>
                <img src={section1_Image1} alt="더샵신문그리니티브랜드소개-image2" />
          ...
          <div className={styles.section}>
            <div className={styles.section8}>
              ...
              <img src={section8Img3} alt="더샵신문그리니티입지환경소개-image2" />
            </div>
          </div>
            ...
            <div className={styles.section2}>
              <div className={styles.textBox}>
                ...
                <div className={`${styles.text2} fadeUpRepeat`}>
                  기대한 모든 프리미엄이<br />더샵신문그리니티에서 펼쳐집니다
                </div>
              ...
              <img src={section2_Image1} alt="더샵신문그리니티아파트 조감도-image3" />
            </div>
          </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img src={section4_Image1} alt="더샵신문그리니티브랜드소개-image4" />
                <div className={styles.text1}>더샵신문그리니티</div>
...
<div className={styles.pcVisitContainer}>
  ...
  <form
    ...
    action="https://formspree.io/f/xnngnwkj"
    method="POST"
  >
    <label htmlFor="name">
    ...
    <button type="submit">등록하기</button>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="더샵신문그리니티오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img src={mobileImageMain} className={styles.mainImage} alt="더샵신문그리니티mobilemain-image1" />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox1}>
            <div className={styles.mainImageTextSub1}>
              장유·율하 생활권 원스톱 인프라<br/>
              장유IC·서김해IC 인접, 광역 접근성<br/>
              (예정) 장유역(부전~마산선)·BRT 연계<br/>
              공원형 조경·특화 커뮤니티
              <br />
            </div>
          ...
          <div className={styles.container1}>
            ...
            <div className={styles.text3}>
              - 더샵 브랜드의 시그니처 라이프<br />
              - 장유·율하 생활권 원스톱 인프라(쇼핑·문화·공공시설 인접)<br />
              - 장유IC, (예정) 장유역(부전~마산선)·BRT 연계로 광역 접근성 강화<br />
              - 남향 위주 4Bay 판상형·공원형 조경·특화 커뮤니티로 완성도 높은 주거<br />
              - 84·93㎡ 중심의 합리적 평면 구성과 수납 특화 설계
            </div>
         ...
         <section className={styles.darkSection}>
          ...
          <div className={styles.container7}>
            ...
            <img src={section8Img3} alt="더샵신문그리니티mobile입지안내-image1" />
          </div>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른<br />
                프리미엄 주거라이프를 <br /> 더샵신문그리니티 모델하우스에서 확인하세요
              </div>
            </div>
            <img src={section2_Image1} alt="더샵신문그리니티mobile조감도-image1" />
          </div>
          <UnitInfoSection />
...
<div className={styles.mobileVisitContainer}>
  ...
  >
    ...
    <button type="submit">등록하기</button>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img src={mobilemap1} alt="더샵신문그리니티오시는길안내-mobileimage2" />
            </div>
          </div> */}
